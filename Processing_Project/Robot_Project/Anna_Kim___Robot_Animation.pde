...
float pupilPace = 1;//how fast the pupil moves is 1
int r = 0;//the variable r equals 0
int b=0;//the variable b equals 0
...
void draw () {
  ...
  }//if the pupilChange is greater than 13, move the pupil to the left by a spead of 1
  if (pupilChange < -16) {
    pupilPace = abs(pupilPace);
  }//if the pupilChange is less than -16, move the pupil to the right by a spead of 1

  fill(r, 204, 165);//I made the attena orange to add a diversity in color
  r=r+1;//increment red by 5
